 ...
 */(function (a) {
    var b, c = this, d = c.document, e = a(d), f = a(c), g = Array.prototype, h = 1.27, i = !0, j = 3e4, k = !1, l = navigator.userAgent.toLowerCase(), m = c.location.hash.replace(/#\//, ""), n = function () {
        ...
        d = d || n, a.getJSON("http://gdata.youtube.com/feeds/api/videos/" + b + "?v=2&alt=json-in-script&callback=?",
            function (a) {
                try {
        ...
        d = d || n, a.getJSON("http://vimeo.com/api/v2/video/" + b + ".json?callback=?",
            function (a) {
                try {
        ...
        d = d || n, a.getJSON("https://api.dailymotion.com/video/" + b + "?fields=thumbnail_medium_url&callback=?",
            function (a) {
                try {
    ...
    Galleria = function () {
        ...
        }), this.cache[b] ? (l.load(m).attr("src", b), this.container) : (l.load(m).error(
            function () {
